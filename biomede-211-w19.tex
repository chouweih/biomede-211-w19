...
\section{Transistors}
\begin{enumerate}
	\item A semiconductor device with three connections used to amplify, rectify, or switch electrical signals.
	\item The two common transistors are NPN and PNP, which consist of a base, emitter, and collector.
	\item N type semiconductors has electrons and P type has holes.
	\item PNP symbol has an arrow going into the base through the emitter, while NPN has an arrow going out of the base.
\end{enumerate}
...
Here is a link to a video that summarizes the diagram and symbols of a circuit: https://www.youtube.com/watch?v=Dl1gFBNa0Ik
